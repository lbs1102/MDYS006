<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\inetpub\wwwroot\MDYS006/application/admin\view\collect\art.html";i:1638323111;s:66:"C:\inetpub\wwwroot\MDYS006\application\admin\view\public\head.html";i:1638323113;s:66:"C:\inetpub\wwwroot\MDYS006\application\admin\view\public\foot.html";i:1638323113;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="mb10">
            ...
            <div class="layui-input-inline w150 m5">
                ...
                <a id="<?php echo $param['cjflag']; ?>_<?php echo $vo['type_id']; ?>" data-href="<?php echo url('index/select'); ?>?tab=art&col=<?php echo $param['cjflag']; ?>_<?php echo $vo['type_id']; ?>&ids=1&tpl=select_type&refresh=no&url=collect/bind" data-width="270" data-height="100" class="j-select" >
                    <?php if($vo['isbind'] == 1): ?>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($vo['art_name']); ?></td>
                <td><?php echo htmlspecialchars($vo['type_name']); ?></td>
                <td><?php echo htmlspecialchars($vo['art_from']); ?></td>
