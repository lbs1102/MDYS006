<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\inetpub\wwwroot\MDYS006/application/admin\view\index\login.html";i:1638323112;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/MDYS006/static/layui/css/layui.css?v=1024">
    <link rel="stylesheet" href="/MDYS006/static/css/admin_style.css?v=1024">
    <style type="text/css">
        body {
            color:#999;
...
<div class="login-box">
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="verify" class="layui-input" lay-verify="verify" placeholder="" maxlength="4"  max="9999"/><img id="verify_img" src="/MDYS006/index.php/verify/index.html" onclick="this.src = this.src+'?'">
            </div>
        </div>
        <?php endif; ?>
...
<script type="text/javascript" src="/MDYS006/static/js/admin_common.js"></script>
